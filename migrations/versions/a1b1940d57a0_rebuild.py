...
Revision ID: a1b1940d57a0
Revises: 
Create Date: 2024-05-11 21:19:22.366188
...
def upgrade() -> None:
    ...
    sa.Column('sourceCity', sa.Integer(), nullable=False),
    sa.Column('destinationCity', sa.Integer(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('travel_id', 'user_id')
    )
